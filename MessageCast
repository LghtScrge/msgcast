...
var messageCast = function() {
    ...
    var _helperList = {
        ...
        "Advanced2": [
            ...
            }
			{
                ...
                onclick: (e)=>{addMessage("ChangeBackground");}
            },
        ],
        "Emotes": [],
        "Cast": [],
    ...
    var _messageList = {
        ...
        /*Location*/
        "GoToDormitory": '${GAME_MANAGER.instance.Send("Location",{location:"Dormitory",avoidEncounters:false,event:false,waitForEncounter:false})}',
        "GoToArboretum": '${GAME_MANAGER.instance.Send("Location",{location:"Arboretum",avoidEncounters:false,event:false,waitForEncounter:false})}',
        "GoToAuditorium": '${GAME_MANAGER.instance.Send("Location",{location:"Auditorium",avoidEncounters:false,event:false,waitForEncounter:false})}',
        "GoToWorkshop": '${GAME_MANAGER.instance.Send("Location",{location:"Workshop",avoidEncounters:false,event:false,waitForEncounter:false})}',
        "GoToLibrary": '${GAME_MANAGER.instance.Send("Location",{location:"Library",avoidEncounters:false,event:false,waitForEncounter:false})}',
        "GoToGym": '${GAME_MANAGER.instance.Send("Location",{location:"Gym",avoidEncounters:false,event:false,waitForEncounter:false})}',
        "GoToWard": '${GAME_MANAGER.instance.Send("Location",{location:"Ward",avoidEncounters:false,event:false,waitForEncounter:false})}',
        "GoToStop": '${GAME_MANAGER.instance.Send("Location",{location:true,avoidEncounters:false,event:false,waitForEncounter:false})}',
...
*/
	...
	function loadBackgroundImageHandler() {
        ...
        if(macroAddedCheck!=null && !macroAddedCheck.classList.contains("MESSAGECASTCustomImages")) {
            ...
            SCENE.instance.UpdateLocation = async (location) => {
                await oldUpdateLocation(location);
                MESSAGECAST.changeBackgroundImage();
            }
            macroAddedCheck.classList.add("MESSAGECASTCustomImages");
        }
    }
